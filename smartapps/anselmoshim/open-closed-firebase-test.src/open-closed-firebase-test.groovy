...
definition(
    name: "Open/Closed Firebase Test",
...
def sinkStatus() {
	if((sinkStatus.latestValue("switch") == "on") && (motionStatus.latestValue("motion") == "inactive"))  {
...
def stoveStatus() {
	...
	if((stoveStatus.latestValue("switch") == "on") && (motionStatus.latestValue("motion") == "inactive"))  {
